    ...
    <>
      ...
      <div className="border-b border-border-subtle bg-gradient-to-b from-surface to-background">
        <div className="mx-auto max-w-[1400px] px-4 py-16">
          {liveCount > 0 && (
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-live/40 bg-live/10 px-3 py-1 text-xs font-semibold text-live">
          ...
          <p className="mt-4 max-w-xl text-lg text-foreground-muted">{t("home.subtitle")}</p>
