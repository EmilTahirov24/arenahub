...
import { resetFanPassword } from "@/app/fan/reset-password/actions";

export default function FanResetPasswordForm({ token }: { token: string }) {
  const [state, formAction, pending] = useActionState(resetFanPassword, undefined);
