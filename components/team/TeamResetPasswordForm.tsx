...
import { resetTeamPassword } from "@/app/team/reset-password/actions";

export default function TeamResetPasswordForm({ token }: { token: string }) {
  const [state, formAction, pending] = useActionState(resetTeamPassword, undefined);
